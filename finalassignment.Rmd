...
The correlation plot below (source: corrplot) provided some clues of the correlated predictors (or variables), which are those with dark colour intersection (see Figure 1).
...
The 'fancyRpartPlot' function was used to plot the classification tree as a dendrogram (see Figure 2).
...
Plot matrix results by the following function (see Figure 3).
